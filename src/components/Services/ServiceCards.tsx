  ...
  return (
    ...
    <SectionLayout className="bg-white">
      <div className="text-center space-y-2 ">
        ...
        <p className="lg:w-2/3 lg:mx-auto text-center text-lg font-light text-subheading">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos eveniet porro molestias, sapiente quam aliquam possimus necessitatibus voluptatibus, quo nesciunt laboriosam deserunt. Reiciendis, deserunt praesentium?</p>
      </div>
