...
const page = () => {
  return (
    <>
    <SectionHeader title="Transportation and Power Industry" />
    <SectionInfo title="Transportation and Power Industry" content={services[4]?.description} image={services[4]?.image}/>
